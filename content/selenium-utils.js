/**
 * Утилита для эмуляции логики Selenium из внутреннего автотеста
...
(function() {
  if (window.__autotestSeleniumUtils || window.SeleniumUtils) return;
  window.__autotestSeleniumUtils = true;

class SeleniumUtils {
  constructor() {
    console.log('🔧 [SeleniumUtils] Инициализация утилиты (логика из внутреннего автотеста)');
